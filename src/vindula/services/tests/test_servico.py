...
from vindula.services.content import IServico
...
class ContentTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.portal.invokeFactory('ServicoFolder', 'test-folder')
    ...
    def test_factory(self):
        self.failUnless('Servico' in self.portal.portal_factory.getFactoryTypes().keys(),
            '%s content type not installed' % 'Servico')

    def test_create(self):
        self.failUnless('foo' in self.folder.objectIds())

    def test_interface(self):
        self.failUnless(IServico.providedBy(self.obj))
